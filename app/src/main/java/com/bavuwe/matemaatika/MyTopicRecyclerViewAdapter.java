...
import com.bavuwe.matemaatika.TopicFragment.OnListFragmentInteractionListener;
import com.bavuwe.matemaatika.dummy.DummyContent.TopicItem;
...
public class MyTopicRecyclerViewAdapter extends RecyclerView.Adapter<MyTopicRecyclerViewAdapter.ViewHolder> {
    ...
    public MyTopicRecyclerViewAdapter(List<TopicItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
